...
4. Resume optimization recommendations tailored to the JD
...
- Suggest project ideas to include
- Suggest resume bullet improvements
- Suggest keywords for ATS optimization

Step 6: Resume Rewrite Suggestions
- Provide improved bullet points
- Suggest new sections if needed
- Suggest reordering of sections

Step 7: Output MUST be in valid JSON format. Do NOT include any text before or after the JSON. Output ONLY the JSON object below:
